  ...
  return (
    ...
    <div className="lg:mx-16 sm:mx-12">
      <header className="pt-4 min-h-0  h-18 lg:grid grid-flow-col b lg:mx-16 sticky top-0 z-30 bg-white">
        <div className=" w-14 flex min-w-fit">
          <img className="h-14 w-auto" src="./Images/LOGO.png" alt="" />
          <h1 className="font-bold text-4xl ml-3 mt-4">SWARM</h1>
        </div>
      ...
      <main className="mx-5 lg:mx-16">
        ...
        <section className="p-5 mt-5 lg:p-7 flex flex-col justify-center items-center bg-gradient-to-r  from-blue-100 to-yellow-100 rounded-2xl">
          <p className="font-extrabold text-blue-900 text-2xl lg:text-5xl">Smart Workflow and Resource Management</p>
          <p className="font-semibold mt-5 text-lg text-justify lg:text-center lg:mx-24">Swarm is a project management methodology that emphasizes collaboration and decentralization. In a Swarm-based approach, projects are broken down into small, manageable tasks that are distributed among a self-organizing team. Each team member takes on multiple roles, and decision-making is distributed among the team members rather than being centralized with a single leader.</p>
        </section>
        ...
        <section className="flex flex-col lg:relative mt-11 m-5 lg:ml-9">
          ...
          <div className="lg:absolute  lg:w-1/2 lg:z-10 right-24 lg:top-20 p-7 rounded-2xl bg-gradient-to-r from-rose-100 to-orange-300 ">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos iusto voluptatibus impedit molestiae consequuntur <br /> voluptatem ut magni unde veniam id. Reprehenderit natus a atque minus, enim maxime et ipsam accusamus.</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos iusto voluptatibus impedit molestiae consequuntur <br /> voluptatem ut magni unde veniam id. Reprehenderit natus a atque minus, enim maxime et ipsam accusamus.</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos iusto voluptatibus impedit molestiae consequuntur <br /> voluptatem ut magni unde veniam id. Reprehenderit natus a atque minus, enim maxime et ipsam accusamus.</p>
          </div>
      ...
      <footer className="bg-white dark:bg-gradient-to-r from-gray-900 to-gray-800">
          <div className="mx-auto w-full container p-6">
              <div className="md:flex md:justify-evenly">
                <div className="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" className="flex items-center">
                        ...
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Swarm</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="https://flowbite.com/" className="hover:underline">Swarm</a>
                            </li>
                            <li>
            ...
            <div className="md:flex-row flex-col md:justify-evenly flex  justify-center">
                <span className="text-sm text-center text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Flowbite™</a>. All Rights Reserved.
                </span>
